...
from app.controllers.v2.tax.tax_receipt import generate_multi_tax_pdf
from app.controllers.v2.tax.tax_receipt_bentong import generate_tax_receipt_bentong
